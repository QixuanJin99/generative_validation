...
_DESCRIPTION = "Stable Diffusion: Waterbirds source domain dataset."

class Waterbirds_Dataset_Base(datasets.GeneratorBasedBuilder):
    ...
    def _generate_examples(self, split, root):
        ...
        split_data = torch.utils.data.Subset(train_ds, train_ids)
        ...
        for idx in range(len(split_data)): 
            ...
            prompt = f"a photo of {bird_label} with background of <wb-source-domain>"
