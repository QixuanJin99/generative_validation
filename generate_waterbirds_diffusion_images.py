...
# landbird_file_prefix = f"{base_dir}/dreambooth/waterbirds_finetune_sd_token2_816_checkpoint-1600/landbird-source/checkpoint-500"
...
# waterbird_file_prefix = f"{base_dir}/dreambooth/waterbirds_finetune_sd_token2_816_checkpoint-1600/waterbird-source/checkpoint-2000"
...
file_prefix = f"/mnt/scratch-lids/scratch/qixuanj/dreambooth/waterbirds_finetune_sd_token2_816_checkpoint-1600/target100_background/checkpoint-2000"
...
output_dir1 = base_dir + "/waterbird_generated_images/" + keyword + "/target100_background/strength1.0"
...
for i in tqdm(range(start_idx, end_idx)):
    ...
    prompt = f"a photo of target background"
    ...
    for j, image in enumerate(image1.images): 
        image.save(output_dir1 + f"/image{i}_{label_offset + j}_{label_map[class_label]}.png")
        
    # if group_label == 0:
    #     # prompt = f"a photo of landbird-target"
    #     prompt = f"a photo of waterbird-source"
    ...
    #     prompt = f"a photo of landbird-source"
